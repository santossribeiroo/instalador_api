...
class MySQL
{
    ...
    public function getAllByAdm($tabela, $adm)
    {
        if ($tabela && $adm) {
            $consulta = "SELECT * FROM " . $tabela. " WHERE adm = '" .$adm. "'";
            $stmt = $this -> db -> query($consulta);
            ...
            throw new \InvalidArgumentException(ConstantesGenericasUtil::MSG_ERRO_ADM_OBRIGATORIO);
    }
