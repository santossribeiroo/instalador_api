...
abstract class ConstantesGenericasUtil
{
    ...
    public const TIPO_GET = ['CLIENT'];
    public const TIPO_POST = ['CLIENT'];
    public const TIPO_DELETE = ['CLIENT'];
    public const TIPO_PUT = ['CLIENT'];
    ...
    /* RECURSO USUARIOS */
    public const MSG_ERRO_ADM_OBRIGATORIO = 'ADM é obrigatório';
    public const MSG_ERRO_ID_OBRIGATORIO = 'ID é obrigatório!';
    public const MSG_ERRO_INFO_OBRIGATORIO = 'Alguns dados não foram preenchidos!';
